...
kubectl set image deployments/client-deployment server=armansiyami/multi-client:$SHA
kubectl set image deployments/worker-deployment server=armansiyami/multi-worker:$SHA
